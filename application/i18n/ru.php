...
return [
    ...
    'not_compatible_with_craft' => 'Не совместимо с выбранной специальностью',
    'not_standard' => 'Не стандартное',
    'does_not_match' => 'Не соответствует соглашению/спецификации',
    'not_compatible_with_plan' => 'Не соответствует плану/стандарту',
    'for_immediate_treatment' => 'Для немедленного исправления',
    'do_not_go_th_stage' => 'Не переходить на следующий этап/специальность',
    'do_not_prc_without_suv_approve' => 'Не начинайть без одобрения проверяющего',
    ...
    'Conditions List' => 'Список условий',
