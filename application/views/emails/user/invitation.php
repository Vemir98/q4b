...
<body class="email-page" style=" margin: 0; padding: 30px 15px; background-image: url(https://qforb.net/media/img/login_bg.jpg); background-repeat: no-repeat; background-size: contain; background-position: center; background-color: #f2f3f8; position: relative; box-sizing: border-box; -moz-box-sizing: border-box; -webkit-box-sizing: border-box;">
    ...
    <div class="q4-email-wrapper" style="<?=($lang == 'he' ? 'direction:rtl' : 'direction:ltr')?>; max-width: 615px; margin: 35px auto 20px; color: #000; box-sizing: border-box; -moz-box-sizing: border-box; -webkit-box-sizing: border-box;">
        <table>
            <tr>
                <td>
            ...
            <tr>
                <td>
                    <div class="q4-email-body" style="background: white; width: 100%; padding: 35px 25px 30px 25px; margin-bottom: 15px; border: 1px solid #d4e1ea; box-sizing: border-box; -moz-box-sizing: border-box; -webkit-box-sizing: border-box;">
                        <h2 style="color: #1ebae5; font-size: 20px; font-weight: normal; font-style: normal; font-family: 'proxima_nova_rgregular', Arial, Helvetica, sans-serif; margin: 0 0 20px 0; line-height: 1;">
                            <?=__('Welcome to Quality management system')?>.
                        </h2>
                        <div>
                            <span style="display: block; color: #708492; font-size: 16px; font-weight: normal; font-style: normal; font-family: 'proxima_nova_rgregular', Arial, Helvetica, sans-serif; line-height: 1; margin-bottom: 7px;">
                                <?=__('Permission granted to use the Q4B system')?>.
                            </span>
                            <span style="display: block; color: #708492; font-size: 16px; font-weight: normal; font-style: normal; font-family: 'proxima_nova_rgregular', Arial, Helvetica, sans-serif; line-height: 1; margin-bottom: 7px;">
                                <?=__('Please')?> <a href="<?=$url?>" style="color: #1ebae5; text-decoration: underline;  font-weight: bold"> <?=__('click on the link')?></a> <?=__('to choose your password and follow the Instructions for using the system')?>.
                            </span>
                        </div>
                    </div>
                </td>
            ...
            <tr>
                <td>
                    <div class="q4-email-footer">
                        <span style="display: block; margin: 0 0 10px 5px; color: #708492; font-size: 14px; font-weight: normal; font-style: normal; font-family: 'proxima_nova_rgregular', Arial, Helvetica, sans-serif; line-height: 1;">
                        ...
                        <span style="display: block; margin: 0 0 0 5px; color: #708492; font-size: 14px; font-weight: normal; font-style: normal; font-family: 'proxima_nova_rgregular', Arial, Helvetica, sans-serif; line-height: 1;">
