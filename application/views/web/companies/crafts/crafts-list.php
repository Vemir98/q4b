        ...
        <div class="modal-content">
            <div class="modal-header q4_modal_header">
                ...
                <div class="q4_modal_sub_header">
                    <h3><?=__('Crafts List')?></h3>
                </div>
            </div>
            <div class="modal-body professions-list-modal-body">
                <p class="professions-list-exist"><?=__('Selected crafts are used in some profession')?></p>

                <div class="professions-list-queue">
                    <div class="professions-list-queue-title"><h3><?=__('Craft')?></h3></div>
                        ...
                        <li>
                            <div class="professions-list-checkbox">
                                <label  class="checkbox-wrapper">
                                    <input type="checkbox"   <?=$item['belongs_to_profession'] ? 'checked' : ''?> disabled="disabled">
