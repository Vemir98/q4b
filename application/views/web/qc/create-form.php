                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 rtl-float-right">
                                        ...
                                        <div class="select-wrapper"><i class="q4bikon-arrow_bottom"></i>
                                            <select class="q4-select q4-form-input" name="project_id">
                                    ...
                                    <div class="form-group col-md-6 rtl-float-right">
                                        ...
                                        <input type="text" class="table_input disabled-input" value=""/>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        <div class="row">
                                            <div class="col-20 rtl-float-right">
                                                ...
                                                <input type="text" class="table_input disabled-input bidi-override" value=""/>
                                            </div>
