        ...
        <div class="pdf-content">
            ...
            <div class="fnl-stg">
                ...
                <div class="fnl-stg-desc">
                    1. קיימים 2 תקנים ישראליים לתחזוקת מבנים:1525 חלק 1, 2 ויש לנהוג לפיהם.
                    <br>
                    2. במידה והנכם מכניסים קבלן ניקיון, יש להקפיד על שימוש מינימאלי במים. הצפת הדירה במים בכמויות גדולות עלולה לגרום לחדירה, הצפת השומשום מתחת לריצוף ולרטיבות בקירות ודלתות החדרים. בנוסף הצפת הדירה עלולה לגרום נזק לדירות אשר סמוכות לדירתכם ובדירה אשר ממוקמת מתחת לדירתכם.
                    <br>
                    3. יש להקפיד על ניקוי עדין וזהיר של הקרמיקות בשירותים, כדי להימנע מפגיעה ברובה (מילוי שבין האריחים) ובאריחי הקרמיקה עצמם.
                    <br>
                    4. במידה והינכם מתכוונים לבצע עבודות שיפוצים בדירה  עליכם לדעת כי אין לבצע שינויים באלמנטים קונסטרוקטיביים כגון קירות, קורות, עמודים ותקרות בטון ללא התייעצות וקבלת אישור מהקונסטרוקטור של הבניין.
                    <br>
                    5. חל איסור לבצע שינויים כל שהם בחזיתות הבניין כתוצאה משיפוץ הדירה או כתוצאה מתוספת אלמנטים שונים לדירה.
                    <br>
                    6. במידה וקיים ריצוף שיש מאבן טבעית בדירה, באחריות הדייר לבצע טיפול תקופתי, אחת לשנה לפחות, לצורך אחזקת הריצוף, טיפול ו/או ליטוש על ידי בעל מקצוע מומחה בנושא.
                    <br>
                    7. חלונות הדירה מיוחדים ויש לנהוג במשנה זהירות בעת ניקוי החלונות. יש לנקות את החלונות עם מים וסמרטוט מגבת בלבד, ללא אמצעים שורטים, ניירות ניגוב שונים, סכיני ניקיון וכלים חדים.
        ...
        <div class="pdf-content">
            ...
            <div class="fnl-stg">
                ...
                <div class="fnl-stg-desc">
                    ...
                    <br>
                    .2 בתקופת הבדק והאחריות אין לעשות כל שימוש, שלא באישור החברה (בכתב), באריחים רזרביים, אשר ימסרו לקונה למשמרת לצורך תחזוקה.
                    <br>
                    .3 היה ולא אשמור ו/או אשתמש בריצוף / קרמיקה זו, לא תהינה לי כל טענה כלפי החברה בנוגע להתאמת צבעים ו/ או התאמת דגמים.
                </div>
            </div>
            <!--final stage 2 end-->
        </div>
