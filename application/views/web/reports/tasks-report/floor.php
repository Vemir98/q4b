        ...
        <table class="responsive_table table table-bordered table-hover">
            ...
            foreach ($data['public'] as $one):?>
                ...
                <tr>
                    <td><?=++$i?></td>
                    <td><?=$one['name']?></td>
                    <td><a class="get-report-places" href="<?=URL::site('reports/tasks/places/floor/'.$floor->id.'/'.$one['id']."/public")?>"><?=$floor->places->where('type','=',Enum_ProjectPlaceType::PublicS)->count_all()?></a></td>
                    <?if((int)$one['used']):?>
        ...
        <table class="responsive_table table table-bordered table-hover">
            ...
            foreach ($data['private'] as $one):?>
                ...
                <tr>
                    <td><?=++$i?></td>
                    <td><?=$one['name']?></td>
                    <td><a class="get-report-places" href="<?=URL::site('reports/tasks/places/floor/'.$floor->id.'/'.$one['id']."/private")?>"><?=$floor->places->where('type','=',Enum_ProjectPlaceType::PrivateS)->count_all()?></a></td>
                    <?if((int)$one['used']):?>
