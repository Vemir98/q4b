			                ...
			                <table class="responsive_table table table-bordered table-hover">
								...
								<tbody>
									...
									<tr>
                                        ...
                                        <?if((int)$one['used']):?>
                                        <td data-th="<?=__('Task Qnty')?>"><a class="get-report-details" href="<?=URL::site('reports/tasks/details/floor/'.$floor->id.'/'.$one['id']."/public")?>"><?=(int)$one['used']?>/<?=(int)$one['total']?></a></td>
                                    <?else:?>
							...
							<table class="responsive_table table table-bordered table-hover">
								...
								<tbody>
									...
									<tr>
										...
										<td data-th="<?=__('Craft')?>"><?=$one['name']?></td>
                                        <?if((int)$one['used']):?>
                                        <td data-th="<?=__('Quantity')?>"><a class="get-report-details" href="<?=URL::site('reports/tasks/details/floor/'.$floor->id.'/'.$one['id']."/private")?>"><?=(int)$one['used']?>/<?=(int)$one['total']?></a></td>
                                    <?else:?>
