            ...
            <ul class="q4-list-items">
                ...
                <li class="q4-list-item">
                    ...
                    <figure>
                        ...
                        <?if($i->image_id):?>
                        <a href="<?=URL::site('projects/company_project_update/'.$i->id)?>"><img src="<?=$i->main_image->originalFilePath()?>" alt="<?=$i->name?>"></a>
                        <?else:?>
                        <a href="<?=URL::site('projects/company_project_update/'.$i->id)?>"><img src="/media/img/camera.png" alt="<?=$i->name?>"></a>
                        <?endif?>
                        <figcaption><a href="<?=URL::site('projects/company_project_update/'.$i->id)?>"><?=$i->name?></a></figcaption>
                        <?else:?>
                            <?if($i->image_id):?>
