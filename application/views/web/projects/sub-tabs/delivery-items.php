                    ...
                    <tabs>
                        <tab name="<?=__('Reserve Materials')?>" :selected="true">
                            <reserve-materials
                                    ...
                                    list-url="<?=URL::site('/acceptance/get_rms_list/'.$_PROJECT->id.'?type='.Enum_ReserveMaterialTypes::Delivery)?>"
                        ...
                        <tab name="<?=__('public_types_of_materials')?>">
                            <public-reserve-materials
                                    ...
                                    copy-url="<?=URL::site('/acceptance/copy_to_project')?>"
                                    update-url="<?=URL::site('/acceptance/update_rms_list')?>"
                                    list-url="<?=URL::site('/acceptance/get_rms_list/'.$_PROJECT->id.'?type='.Enum_ReserveMaterialTypes::PublicDelivery)?>"
                                    project-id="<?=$_PROJECT->id?>"
                        ...
                        <tab name="<?=__('Transferable items')?>">
                            <transferable-items
                                    ...
                                    list-url="<?=URL::site('/acceptance/get_ti_list/'.$_PROJECT->id.'?type='.Enum_TransferableItemsTypes::Delivery)?>"
                                    project-id="<?=$_PROJECT->id?>"
                        ...
                        <tab name="<?=__('public_transferable_items')?>">
                            <public-transferable-items
                                    ...
                                    copy-url="<?=URL::site('/acceptance/copy_to_project')?>"
                                    update-url="<?=URL::site('/acceptance/update_ti_list')?>"
                                    list-url="<?=URL::site('/acceptance/get_ti_list/'.$_PROJECT->id.'?type='.Enum_TransferableItemsTypes::PublicDelivery)?>"
                                    project-id="<?=$_PROJECT->id?>"
