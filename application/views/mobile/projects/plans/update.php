                    ...
                    <div class="plans-modal-dialog-top">
                        <div class="row">
                            ...
                            <div class="form-group col-28 rtl-float-right">
                                <label class="table_label"><?=__('Property')?></label>
                                 <div class="select-wrapper"><i class="q4bikon-arrow_bottom"></i><select class="q4-select q4-form-input qc-prop<?=$disabled?>" name="object_id">
                                        <?foreach($_PROJECT->objects->find_all() as $obj):?>
                                            <? if($item->object_id == $obj->id) $defaultObject = $obj?>
                                            <option <?=$item->object_id == $obj->id ? 'selected="selected"' : ''?> value="<?=$obj->id?>" data-min="<?=$obj->smaller_floor?>" data-max="<?=$obj->bigger_floor?>"><?=$obj->type->name?> - <?=$obj->name?></option>
                                        <?endforeach?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-28 rtl-float-right">
                                ...
                                <div class="select-wrapper"><i class="q4bikon-arrow_bottom"></i><select id="plans-profession-id" class="q4-select q4-form-input plan-profession<?=$disabled?>" name="profession_id">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-14 rtl-float-right">
                                ...
                                <input name="custom_number" value="<?=!empty($item->place->custom_number) ? $item->place->custom_number : $item->place->number?>" type="text" class="q4-form-input plan-place-number disabled-input">
                            </div>
                            <?$disabledPlace = $item->place->loaded() && !$disabled  ? '':' disabled-input'?>
                            <div class="form-group col-14 rtl-float-right">
                                <label class="table_label"><?=__('Element id')?></label>
                                <input name="place_number" value="<?=$item->place->number?>" type="text" class="q4-form-input plan-place-number<?=$disabled?>">
                            ...
                            <div class="form-group col-28 rtl-float-right multi-select-col">
                                ...
                                <div class="multi-select-box">
                                    <div class="select-imitation">
                                        <span class="select-imitation-title<?=$disabled?>">
                        ...
                        <div class="row">
                            <div class="form_row">
                                ...
                                <div class="form-group col-md-6 rtl-float-right">
                                    ...
                                    <?$fileIterator = 1;?>
                                    <div data-structurecount="<?=count($files)?>" class="qc-image-list-mobile q4-owl-carousel">
                                        <?foreach ($files as $number => $file):?>
                                            <div class="item qc-image-list-mobile-item">
                                                <a data-url="<?=$file->originalFilePath()?>" title="<?=$file->original_name?>"  target="_blank">
                                                    ...
                                                    <span class="modal-img-upload-date">
                                                        (<?=__('uploaded').':'.date('d.m.Y',$file->created_at)?>)&#x200E;
                                                    </span>
                                                </a>
                                            </div>
                                        <?endforeach?>
